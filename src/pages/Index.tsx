...
const Index = () => {
  ...
  return (
    <div className="min-h-screen text-gray-900 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-[75vh] px-6">
        <div className="mb-0">
      ...
      <div className="relative z-10 bg-white py-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 max-w-5xl mx-auto">
            {/* Card 1 - Blue */}
            <div className="bg-blue-400 rounded-2xl aspect-square p-6 flex items-end">
