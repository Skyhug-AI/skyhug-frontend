      ...
      <div className="flex-1 flex items-center justify-center p-6 md:p-12 relative z-10">
        <div className="w-full max-w-[600px] animate-fade-in">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl md:text-3xl font-normal mb-3">Let's get to know you 🌟</h1>
            <p className="text-[#9b9b9b] text-base">This helps us personalize your experience</p>
          </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-[#616161] text-center">{getTherapistStyleText()}</p>
                </div>
              </div>

              {/* Age */}
              <div className="space-y-2">
                <Label htmlFor="age" className="text-[15px] text-[#616161] font-normal">
                  Age
                </Label>
                <Input 
                  id="age" 
              ...
              {/* Occupation */}
              <div className="space-y-2">
                <Label htmlFor="occupation" className="text-[15px] text-[#616161] font-normal">
                  Occupation
                </Label>
                <Input 
                  id="occupation" 
                  ...
                  {...register('occupation')}
                />
                {errors.occupation && <p className="text-sm text-rose-300 mt-1">{errors.occupation.message}</p>}
              </div>
              ...
              <div className="space-y-2">
                ...
                <Select onValueChange={(value) => setValue('sexual_preference', value)}>
                ...
                {errors.sexual_preference && <p className="text-sm text-rose-300 mt-1">{errors.sexual_preference.message}</p>}
              </div>

              {/* Self Diagnosed Issues */}
              <div className="space-y-2">
                <Label htmlFor="self_diagnosed_issues" className="text-[15px] text-[#616161] font-normal">
                  Self-Diagnosed Issues <span className="text-[#9b9b9b]">(Optional)</span>
                </Label>
                <Textarea 
              ...
              {/* Topics on Mind */}
              <div className="space-y-2">
                <Label htmlFor="topics_on_mind" className="text-[15px] text-[#616161] font-normal">
                  What's on your mind? <span className="text-[#9b9b9b]">(Optional)</span>
                </Label>
                <Textarea 
                  id="topics_on_mind"
