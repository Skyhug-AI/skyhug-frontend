      ...
      <div className="flex-1 flex items-center justify-center p-6 md:p-12">
        <div className="w-full max-w-[480px] animate-fade-in">
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-[24px] border border-white/40 shadow-[0_8px_20px_rgba(0,0,0,0.05)] p-8 md:p-10">
            ...
            <SocialLoginButton provider="google" onClick={handleGoogleSignIn} disabled={loading} />
            
            <div className="mt-8 text-center">
              <p className="text-[#9b9b9b] text-[15px]">
                Don't have an account?{' '}
                <Link to="/signup" className="text-serenity-600 hover:text-serenity-700 font-medium hover:underline transition-colors">
