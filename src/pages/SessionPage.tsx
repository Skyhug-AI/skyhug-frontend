...
const SessionPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#f9fafe] to-[#f4f2ff] flex flex-col">
      <header className="border-b border-blue-100/40 bg-white/80 backdrop-blur-sm sticky top-0 z-50 shadow-sm">
