    ...
    <button
      ...
      className={cn(
        ...
        [
          ...
          `after:animate-[pulse-ring_2s_ease-out_infinite] after:scale-[${isRecording && isSpeaking ? getScaleStyle(1.05) : '1.05'}]`,
          "before:content-[''] before:absolute before:inset-[-8px]",
          "before:bg-orb-gradient before:opacity-20 before:rounded-full",
          `before:animate-[pulse-ring_2.4s_ease-out_infinite] before:scale-[${isRecording && isSpeaking ? getScaleStyle(1.1) : '1.1'}]`,
          "[&>div:nth-child(1)]:content-[''] [&>div:nth-child(1)]:absolute [&>div:nth-child(1)]:inset-[-12px]",
          "[&>div:nth-child(1)]:bg-orb-gradient [&>div:nth-child(1)]:opacity-15 [&>div:nth-child(1)]:rounded-full",
          `[&>div:nth-child(1)]:animate-[pulse-ring_2.8s_ease-out_infinite] [&>div:nth-child(1)]:scale-[${isRecording && isSpeaking ? getScaleStyle(1.15) : '1.15'}]`,
          "[&>div:nth-child(2)]:content-[''] [&>div:nth-child(2)]:absolute [&>div:nth-child(2)]:inset-[-16px]",
          "[&>div:nth-child(2)]:bg-orb-gradient [&>div:nth-child(2)]:opacity-10 [&>div:nth-child(2)]:rounded-full",
          `[&>div:nth-child(2)]:animate-[pulse-ring_3.2s_ease-out_infinite] [&>div:nth-child(2)]:scale-[${isRecording && isSpeaking ? getScaleStyle(1.2) : '1.2'}]`,
