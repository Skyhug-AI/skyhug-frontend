    ...
    <footer className="w-full bg-white border-t border-border py-8 px-4 md:px-8 relative z-10">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><a href="/terms" className="text-muted-foreground hover:text-skyhug-500 transition-colors">Term of Services</a></li>
            <li><a href="/privacy" className="text-muted-foreground hover:text-skyhug-500 transition-colors">Privacy Policy</a></li>
            <li><a href="/disclaimer" className="text-muted-foreground hover:text-skyhug-500 transition-colors">Disclaimer</a></li>
          </ul>
        </div>
      </div>
